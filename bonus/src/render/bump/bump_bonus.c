...
{
	h[0] = get_bump_height(hit->object->material.bump_img, xy[0], xy[1], wh);
	h[1] = get_bump_height(hit->object->material.bump_img, xy[0] + 1, xy[1],
			wh);
	h[2] = get_bump_height(hit->object->material.bump_img, xy[0], xy[1] + 1,
			wh);
}
